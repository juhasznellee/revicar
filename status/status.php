...
<body>
    ...
    <div class="newItem">
        <form method="post" action="status_insert_item.php">
            ...
            if($result->num_rows > 0){
                ...
                while($row = $result->fetch_assoc()){ ?>
                    <tr class="hoveredTr">
                        ...
                        <td><a href="status_delete_item.php?name=<?php echo $row['name']; ?>&id=<?php echo $row['id']; ?>"><img class='delete' src="../images/delete.png" alt="Delete"></a></td>
                    </tr>
                <?php }
                $result->free();
            }
